            ...
            <tr>
                ...
                <td>
                    <div class="button-group tiny">
                        <a href="edit_crew.php?id=<?= $row['id']; ?>" class="button primary">Edit</a>
                        <a href="delete_crew.php?id=<?= $row['id']; ?>" class="button alert" onclick="return confirm('Are you sure?')">Delete</a>
                    </div>
                </td>
            </tr>
        <?php endforeach; ?>
