...
<head>
    ...
    <title>Firefly Draft Configuration</title>
...
<body>
    <h1>Firefly Draft Configuration</h1>
    <form action="run_draft.php" method="post">
        ...
        <div class="number-button-group">
            <label>Number of Crew Needed per Player:</label>
            <div id="crewNeededButtons">
            </div>
            <input type="hidden" id="numCrewNeededInput" name="numCrewNeeded" value="5">
        </div>
        <div id="draftLeaderContainer">
            <button type="button" id="draftLeaderButton" class="leader-toggle-button">Draft a Leader</button>
            <input type="hidden" id="draftLeaderInput" name="draftLeader" value="1">
        </div>
